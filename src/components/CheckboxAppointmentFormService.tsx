...
interface CheckboxAppointmentFormProps {
    ...
    //
    inputDataService: any //this state to open the others
    setInputDataService: any // Assuming setInputData is a function that accepts a string
    inputName: string
                  ...
                  <FormControl>
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => {
                        ...
                        // Toggle the visibility of input field based on selection of "Others"
                        setInputDataService(
                          checked && item.id === "6" 
                        );
                      }}
